...
author: "Deepak K Gupta (MScBA - 16200660)"
date: "March 14, 2017"
output:
  pdf_document:
    fig_caption: yes
...
attach(oj)
pairs(~oj$logmove+oj$price, pch=21,main="Scatter plot of Log of the number of units Sold vs Price of Orange Juice",bg= c("red", "blue", "yellow")[unclass(oj$brand)])

plot(oj$logmove,oj$price, xlab="Units Sold",ylab="Price",pch=21,col=topo.colors(3)[unclass(oj$brand)])
...
```
## Wealthiest Store and Poorest Store
...
summary(mhigh)
plot(logmove~price,data=oj1,xlim=c(0,4),ylim=c(0,13),main="Store in the Wealthiest neighborhood")
abline(mhigh)
## store in the poorest neighborhood
mlow=lm(logmove~price,data=oj2)
summary(mlow)
plot(logmove~price,data=oj2,xlim=c(0,4),ylim=c(0,13),main="Store in the poorest neighborhood")
abline(mlow)
```
