---
title: "MIS40970 - Data Mining for Business Analytics"
author: "Deepak Kumar Gupta (MScBA - 16200660)"
...
-Dominicks sas outlier less than 3/2 times of lower quartile. one outlier is more than 3/2 time of upper quartile. Also, majority of price range of Dominicks is more than the median value and it has range of 1.6 to 2 (approx)
-Minute.maid has about 5 outlier less than 3/2 times of lower quartile.
-Tropicana has few outliers closer to the minmium of lower quartile whiskers.
Overall, with the help of boxplot, one can interepret the distribution of figure around quartile of a median value. That will help user to identify outlier values and then perform detailed data analysis to find trends and pattern among datasets.
...
Scatterplot help one to identify the relation among two variables, if one changes then how change in other is reflected. It could be no change, increase or decrease in the value. Similarly, for orange juice data, scatterplot of Units Sold vs Price shows that the Price of tropicana juice is lowered compared to other two, and sold more number of units compared to Minute Maid and Dominicks. 

Dominicks has sold units in range of 7-11, but its price is highest among all three brands. On the otherhand, minute maid unit sold is between 8-12, and average price per unit is 2.5.

Overall, Maximum price of a unit juice is 4.0 and minimum price is approx 1.0. Max unit sold is 14 and minmum number of unit sold is 4.
...
###Analysis of Correlation among demographics variables. The closer correlation coeff(r) is to +1 or -1, the more closely the two variables are related. If r is close to 0, it means there is no relationship between the variables. Below are few sample correlated variables.
